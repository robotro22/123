...
from PyQt5.QtWidgets import (QApplication, QWidget,
    QHBoxLayout, QVBoxLayout, QGridLayout,    QGroupBox, QRadioButton,
...
class TestWin(QWidget):
    ...
    def initUI(self):
        ...
        self.test1 = QPushButton(txt_starttest1, self)
        self.test2 = QPushButton(txt_starttest2, self)
        self.test3 = QPushButton(txt_starttest3, self)

        self.test_name = QLabel(txt_name)
        self.test_age = QLabel(txt_age)
        self.test1 = QLabel(txt_test1)
        self.test2 = QLabel(txt_test2)
        self.test3 = QLabel(txt_test3)

        self.test_timer = QLabel(txt_timer)
    ...
    def connects(self):
        ...
        self.btn_test2.clicked.connect(self.next_sits)
